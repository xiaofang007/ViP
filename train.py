...
def reset_cfg(cfg, args):
    ...
    if args.descriptor_path:
        cfg.DESCRIPTOR_PATH = args.descriptor_path
...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.VIP = CN()
    cfg.TRAINER.VIP.N_CTX = 4  # number of context vectors
    cfg.TRAINER.VIP.CSC = False  # class-specific context
    cfg.TRAINER.VIP.PREC = "fp16"  # fp16, fp32, amp
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config-file", type=str, default="", help="path to trainer config file"
    )
    parser.add_argument(
        "--descriptor-path", type=str, default="", help="path to config file"
    )
    parser.add_argument(
        "--dataset-config-file",
        type=str,
